---
title: '【数据结构与算法1】数学篇：从几个专题审视算法课的数学部分'
...
1. 直觉图片
![](post-images/20250911103953.png)
...
3. 精确定义
![](post-images/20250911103121.png)

![](post-images/20250911103208.png)

![](post-images/20250911103239.png)
...
![](post-images/20250911144849.png)
...
![](post-images/20250911145009.png)

![](post-images/20250911145031.png)

证明：$an+b=O(n^2)$。

![](post-images/20250911145054.png)
...
![](post-images/20250911152314.png)
![](post-images/20250911152337.png)

不存在的性质：
![](post-images/20250911152359.png)

### 对阶乘的额外说明

要一眼看到 $\lg n!$ 和 $\sum_{k=1}^n \lg k$ 这两种形式，就能想到它们的互相转换。

![](post-images/20251225144900.png)
除了结论，
...
![](post-images/20250910203548.png)
...
![](post-images/20251225143325.png)
...
![](post-images/20251225151810.png)
...
![](post-images/20251225152252.png)
### 和式的上界

第一种：**利用大小关系** $a_k \le \max a_k$
第二种：**利用比值** $a_k \le a_1r^k$

![](post-images/20251225153046.png)
![](post-images/20251225153054.png)
...
![](post-images/20251225145728.png)
...
> ![](post-images/20251225150606.png)
> **求和式 <= 积分下限多取一个**（积分多取一个大的）。
> 即 $\sum^{n}_{k=2} {1 \over k} \le \int^{n}_{1} {1 \over x}dx=\ln n+1$ 。
> ![](post-images/20251225150536.png)

从而有以下上下界证明过程：

![](post-images/20251225150100.png)
![](post-images/20251225150107.png)

#### 用积分近似求和

上述微元法所揭示的积分和求和的关系，还可以用于近似。
例如下式
![](post-images/20251229220646.png)
可以近似为上限多1的积分：
![](post-images/20251229221006.png)
（顺便把 $\log_2i$ 写成 $\ln x \over \ln 2$ 了）

下述是后面的具体计算的说明。关键是上面，**可以用积分来近似求和**。
这个积分是可以积出来的，比如把x塞进dx里然后再分部积分之类的。
![](post-images/20251229221056.png)
![](post-images/20251229221106.png)
...
![](post-images/20251225154650.png)
思考：
为了解上述递归方程，我们希望能够**构造出两个上下限不同的和式作差**。
因此，首先把 $n$ 乘上去，然后变限，即可进行进一步求解。
![](post-images/20251225154832.png)
![](post-images/20251225154857.png)
...
例1：加减
![](post-images/20251225153319.png)

例1的解：两个变量有加减关系，直接代入。
![](post-images/20251225153347.png)

****

例2：比值
![](post-images/20251225153406.png)

例2的解：两个变量有比值关系，需要换元到指数再代入。
![](post-images/20251225153716.png)
...
![](post-images/20251225154004.png)
用代入法容易解出 $\Theta(n^2)$ 。
...
即它们的递归方程为
![](post-images/20251225154243.png)

接下来**假设各种情况是等概率的**，总共 $n$ 种情况，每种情况的概率是 $1/n$ 。
则平均情况即将 $T(n)$ 置为期望值，为
![](post-images/20251225154514.png)
即
![](post-images/20251225154526.png)
这是一个递归方程的和式，可以参见前述“求和符号及其上界-递归方程的和式”部分，通过**构造不同上下限的和式进行相减**，把它转化成如下递归方程。
![](post-images/20251225155216.png)
然后就可以通过代入法进行求解了。
![](post-images/20251225155235.png)


我们也可以用积分近似上述和式，直观验证我们得到的结果。
![](post-images/20251225162649.png)
### 递归树
...
例1
![](post-images/20251225160633.png)
...
例1解：
![](post-images/20251225162040.png)
...
> ![](post-images/20251225191202.png)
...
****
eg1.
![](post-images/20251225191124.png)
解：$log_24=2$，$f(n)=n=O(n^{2-1})$ ，$\epsilon=1$，则 $T(n)=\Theta(n^2)$ 。
****
eg2.
![](post-images/20251225191326.png)
解：$T(n)=\Theta(n^2 \lg n)$ 。
****
eg3.
![](post-images/20251225191353.png)
解：
...
****
eg4.
![](post-images/20251225192311.png)
解：
先验证条件1。
...
![](post-images/20251225212157.png)
![](post-images/20251225212751.png)
![](post-images/20251225212757.png)
g. $n^2 + (n-2)^2 + ... + 2^2 = \sum_{i=0}^{n-1} (n-2i)^2 = \sum_{i=0}^{n-1} (n^2 - 4ni + i^2)$
拆分开的三个求和式我们都会算。所以是 $\Theta(n^3)$ 。

![](post-images/20251225193831.png)
...
![](post-images/20251225213831.png)
备注：
...
![](post-images/20251225214605.png)
...
****
例1
![](post-images/20251228174203.png)
...
****
例2
![](post-images/20251228173853.png)
...
![](post-images/20251228175132.png)
****
例3
![](post-images/20251228174238.png)
...
![](post-images/20251228224504.png)
![](post-images/20251228224519.png)



[从主方法到Akra-Bazzi定理 - 知乎](https://zhuanlan.zhihu.com/p/311690676)
![](post-images/20251228175530.png)

![](post-images/20251228175546.png)
![](post-images/20251228175650.png)
![](post-images/20251228175659.png)
...
![](post-images/20251229224334.png)

接下来分析这个随机变量单个的期望。
![](post-images/20251229224518.png)
...
![](post-images/20251226232533.png)
![](post-images/20251226232539.png)
![](post-images/20251226232544.png)
![](post-images/20251226232621.png)
![](post-images/20251226232626.png)
![](post-images/20251226232636.png)
![](post-images/20251226232641.png)
![](post-images/20251226232649.png)
![](post-images/20251226232653.png)
![](post-images/20251226232658.png)
![](post-images/20251226232705.png)
![](post-images/20251226232710.png)
![](post-images/20251226232716.png)
...
2. 无冲突
![](post-images/20251226231954.png)
![](post-images/20251226232012.png)

3. 使用的空间为 $O(n)$
![](post-images/20251226232046.png)
![](post-images/20251226232051.png)
![](post-images/20251226232056.png)
...
![](post-images/20251226234503.png)
![](post-images/20251226234524.png)
![](post-images/20251226234535.png)
...
![](post-images/20251226170426.png)
...
![](post-images/20251226170453.png)
...
> ![](post-images/20251226174833.png)
>
...
![](post-images/20251226175012.png)
...
****
聚合法：
![](post-images/20251226184522.png)
除了一堆的1，还需要很散地加一些2、4、8等等。
n次插入的总开销 <= n + (2^j)从0加到lg n-1 <= 3n = O(n)
![](post-images/20251226184709.png)
...
![](post-images/20251226184306.png)
...
![](post-images/20251226172413.png)
...
![](post-images/20251226161452.png)
...
![](post-images/20251226161510.png)
![](post-images/20251226161517.png)
![](post-images/20251226161525.png)
...
![](post-images/20251226234849.png)
![](post-images/20251226234856.png)
![](post-images/20251226235255.png)
![](post-images/20251226235304.png)
![](post-images/20251226235318.png)
![](post-images/20251226235445.png)
...
****
eg1.
![](post-images/20251201160519.png)
 $C=(12,16,15,0,0)$ 。
 ****
...
****
eg1再练一遍。
![](post-images/20251227123217.png)
解：将其转化成min和<=得到的=。
...
![](post-images/20251227125228.png)
...
****
eg1
![](post-images/20251227135409.png)
转换成标准形
min -12x1-15x2
s.t. x1+2x2+x3=480
x1+x2+x4=300
...
![](post-images/20251227144915.png)
...
![](post-images/20251227144927.png)
...
![](post-images/20251227144949.png)
...
![](post-images/20251227145010.png)

#### eg4

![](post-images/20251227145029.png)
首先添加人工变量说是
